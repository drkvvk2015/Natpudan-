...
- [EMOJI] ANDROID_HOME environment variable not set
...
2. Go to **File** [RIGHT] **Settings** (Windows/Linux) or **Android Studio** [RIGHT] **Preferences** (macOS)
3. Navigate to **Appearance & Behavior** [RIGHT] **System Settings** [RIGHT] **Android SDK**
...
- [OK] Android SDK Platform (API 34 or latest)
- [OK] Android SDK Build-Tools (34.0.0 or latest)
- [OK] Android SDK Command-line Tools (latest)
- [OK] Android Emulator (optional, for testing)
