...
try {
    ...
    Write-Host "`n✓ Patient intake created successfully!" -ForegroundColor Green
    ...
    Write-Host "`n✓ Patient intake retrieved successfully!" -ForegroundColor Green
    ...
    Write-Host "`n`n✓ All API tests passed!" -ForegroundColor Green
